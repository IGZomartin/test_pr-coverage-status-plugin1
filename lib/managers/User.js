...
function updateUsers(conditions, projection, options, callback) {
  User.update(conditions, projection, options, callback);
}
...
module.exports = { updateUsers, subscribe, unsubscribe, create, get: getUser, verifyEmail, list: listUsers};
