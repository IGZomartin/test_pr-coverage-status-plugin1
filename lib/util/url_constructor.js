...
function switchToHttp(urlToSwitch) {
  return urlToSwitch.replace('https', 'http');
}

module.exports = { getPlistUrl, createFilePath, getDownloadCompilationUrl, getProductImageRelativeUrl, switchToHttp };
